...
hash-file: hash-file.o sha256/sha256.o vec/vec.o 
	@echo '[01;32m  [LD]    [01;37mhash-file[00m'
	$(Q)$(CC) -o hash-file $(LDFLAGS) hash-file.o sha256/sha256.o vec/vec.o 
...
hash-file.clean:  hash-file.o.clean sha256/sha256.o.clean vec/vec.o.clean
...
hash-file.o: hash-file.c ./vec/vec.h ./sha256/sha256.h ./common.h
...
install: subdirs.install hash-file.install hash-file.o.install sha256/sha256.o.install vec/vec.o.install
	@:

subdirs.install:

uninstall: subdirs.uninstall hash-file.uninstall hash-file.o.uninstall sha256/sha256.o.uninstall vec/vec.o.uninstall
	@:
...
clean: hash-file.clean hash-file.o.clean sha256/sha256.o.clean vec/vec.o.clean
